...
export function ConnectionControls({ index, neighborhood }: ConnectionControlsProps) {
  ...
  // Depth/relationship-type controls eat into the small viewport on phones,
  // so they start collapsed there — desktop and tablet keep today's
  // always-open behavior since there's room to spare.
